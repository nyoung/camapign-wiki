...
**Session 10 (Medical Union compound):** Negotiated entry for Boris and [[Falconius Thorncobble]] when they posed as rat catchers — reasonable given the compound's alarming rat population. The compound contained fresh graves, makeshift alchemy equipment, bodies on tables and floor, and signs of tunneling through the city wall.

**Session 11 (confrontation):** Attempted to claim the dead bodies were authorized for medical supplies by "the [[Church of Morr]]" — the documents produced were poorly forged (signed only with an X). Attempted to bribe the party with 20 freshly minted Nordland crowns. Admitted that [[Hugo (Medical Union)|Hugo]] had retrieved bodies from priests at Salzenmund for medical testing. Became evasive when the courtyard graves were raised. The compound also contained vials labeled with diseases: green river pox and purple brain pox.

**Session 11 (captured):** Surrendered after combat. Delivered to the [[Temple of Verena]] along with [[Marx Khlesl]].
