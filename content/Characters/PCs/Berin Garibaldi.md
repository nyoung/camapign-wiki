...
player:
species: Human
career: Novitiate (Knights of the Blazing Sun)
career_path:
  - Horse Trader
  - Novitiate (Knights of the Blazing Sun)
status: alive
status_tier:
status_standing:
age:
...
# Berin "Orsetto" Garibaldi

## Description
Berin is a lean, pockmarked southerner with darker skin and the careful bearing of someone trained in both discipline and observation. He wears frayed but clearly quality clothing bearing the golden sunburst of the [[Knights of the Blazing Sun]], the fraying an honest record of real hardship. He is accompanied everywhere by his horse [[Orazio]] — a large, friendly dark brown animal who noses at people who smell of carrots and responds to Berin's voice across a chaotic courtyard.
...
## Background
Berin's background spans two careers that sit in unusual harmony: horse trader and Myrmidian novitiate. The first gave him practical knowledge of animals, travel, and commerce; the second gave him discipline, formal bearing, medical training, and the capacity to read classical texts. He was introduced to the party in [[Beekerhoven]] by a priestess of Verena, brought in as a reliable replacement for mercenaries who had fled with their payment. He joined on the party's warrant for [[Professor Udo Stradovski]] and has remained.

## Career Path
| Career | Class | Tier |
|--------|-------|------|
| Horse Trader | Ranger | ? |
| Novitiate — Knights of the Blazing Sun | Warrior | ? |
...
## Trappings of Note
- [[Orazio]] — large, dark brown horse; friendly
- Medical knowledge (functional)

## Relationships
- [[Temple of Verena]] — added to party's warrant by a Verena priestess in Beekerhoven
- [[Orazio]] — his horse
- Party — joined at [[Beekerhoven]] on 23 Nachexen 2512
